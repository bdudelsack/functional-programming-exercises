...
\title{\small{6. Übung zur Vorlesung "Fortgeschrittene funktionale Programmierung"}\\\vspace{.5cm}\huge{Typklassen}}

\begin{document}

\maketitle

\section{Typklasse Appendable}
